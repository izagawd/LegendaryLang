...
public interface IMonomorphizable : IDefinition
{
    ...
    /// <returns>
    ///     Returns generic parameters from a lang path if the functin can be monomorphized to itif not, should return
    ///     null
    /// </returns>
    public ImmutableArray<LangPath>? GetGenericArguments(LangPath path);

    /// <summary>
    ///     NOTE: DO NOT ADD TO SCOPE! OR CODEGEN THE RETURNED CONCRETE DEFINITION!! <see cref="CodeGenContext" /> will handle
    ///     that!!
    /// </summary>
